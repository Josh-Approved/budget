/**
 * Tip-jar store product ids for Budget — app-owned (NOT synced from the
...
export const TIP_PRODUCT_IDS = [
  'com.joshapproved.budget.tip.tier1',
  'com.joshapproved.budget.tip.tier2',
  'com.joshapproved.budget.tip.tier3',
  'com.joshapproved.budget.tip.tier4',
  'com.joshapproved.budget.tip.tier5',
] as const;
